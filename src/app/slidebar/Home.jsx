...
import { Zap, Users, DollarSign, Wallet, Clock, UserCog } from 'lucide-react';
...
const Home = () => {
  ...
  const faqData = [
    {
      question: "What are the advantages of hiring remote engineers and teams?",
      answer: "Hiring remote engineers and teams offers access to a global talent pool, increased flexibility, potential cost savings, and diverse perspectives. It allows companies to scale quickly and efficiently without geographical constraints."
    },
    {
      question: "What kind of talent does Turing provide?",
      answer: "Turing provides a wide range of vetted software engineering talent, including full-stack developers, front-end and back-end specialists, mobile app developers, data scientists, AI/ML engineers, and more. All our engineers are rigorously screened for technical skills and communication abilities."
    },
    {
      question: "What other services does Turing offer?",
              ...
              <div className=" mx-auto px-4 py-8">
                <div className="flex justify-between items-center mb-8">
                  ...
                  <div className="flex space-x-2">
                    <button className="border border-white text-white px-4 py-2 rounded hover:bg-white hover:text-blue-900" onClick={() => router.push("/Login")} >Login</button>
      ...
      <div className='contentdescription'>
        ...
        <div className='box1'>
          ...
          <div className='contentaid'>
            ...
            <div className='content1' >
              <h1>how to use it?</h1>
              <p>enables users to browse an authentic database of lawyers; by expertise, location, and case type. Moreover, detailed lawyer profiles involve qualifications, experience, rating, and reviews. Features include direct communication options available for quick consultations via chatting, calling, or emails. The interface is easily understandable to book appointments for law experts or hire them regarding any specific legal needs as this will ensure a flawless and trustworthy user experience.</p>
            </div>
          </div>
        </div>
      </div>
